...
public class item_recycler_adapter_stocks extends RecyclerView.Adapter<item_recycler_adapter_stocks.ViewHolder> {
    ...
    // <-- FIXED: Ensure this constructor is PUBLIC
        ...
        holder.itemView.setOnLongClickListener(v -> {
            ...
            new AlertDialog.Builder(context)
                    ...
                    .setPositiveButton("Yes", (dialog, which) -> {
                        ...
                        model.isSold = newSoldStatus; // Make sure isSold is public or use a setter
    ...
    // --- Add a public setter for the 'isSold' field in item_recycler_model_stocks if needed ---
    // If item_recycler_model_stocks.isSold is not public, add this method:
    // public void setSoldStatus(boolean isSold) { this.isSold = isSold; }
    // And in onBindViewHolder, use: model.setSoldStatus(newSoldStatus);
}