...
public class SelectedItemAdapter extends RecyclerView.Adapter<SelectedItemAdapter.ViewHolder> {
    ...
    private GenerateBillFragment parentFragment;
    private Context context;
    private databaseSystem dbHelper;

    public SelectedItemAdapter(ArrayList<SelectedItem> selectedItems, GenerateBillFragment fragment) {
        ...
        holder.removeButton.setOnClickListener(v -> {
            ...
            if (currentPosition != RecyclerView.NO_POSITION) {
                ...
                if(parentFragment != null) {
                    parentFragment.updateSelectedItemsEmptyState();
                }
            }
        });
    }
